...
from .views import product_list, product_detail, add_to_cart, cart_detail, remove_from_cart, checkout_view,apply_coupon,send_otp,verify_otp,place_order, order_success, download_invoice, contact
